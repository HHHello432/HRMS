  ...
  >
    ...
    <a-form-item>
      <a-row justify="space-between" align="center" class="w-full">
        <a-checkbox v-model="loginConfig.rememberMe" :class="{'dark-mode':isDarkMode}">记住我</a-checkbox>
        <p><WarningFilled />   如忘记密码请联系管理员</p>
      </a-row>
    </a-form-item>
    <a-form-item>
