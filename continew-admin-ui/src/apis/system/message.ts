...
/** @desc 删除消息 */
export function deleteMessageOwer(ids: string | Array<string>) {
  return http.del(`${BASE_URL}/userOneDelete/${ids}`)
}

/** @desc 标记已读 */
export function readMessageOwer(ids?: string | Array<string>) {
  return http.patch(`${BASE_URL}/userOneRead`, ids)
}
